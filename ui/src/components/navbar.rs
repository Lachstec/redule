            ...
            <nav class="sticky top-0 z-50">
                <div class="w-screen mx-auto px-4 py-2">
                    <div class="flex items-center justify-between h-16">
                        <span class="text-4xl text-gray-900 font-semibold italic text-sky-500">{"Redule"}</span>
                        <div class="flex space-x-10 text-gray-900 text-xl">
                            ...
                            <button>
                                <a href="https://github.com/Lachstec/redule">
                                    <svg class="hover:fill-sky-500 transition ease-in-out" width="24" height="24">
